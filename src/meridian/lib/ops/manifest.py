...
_OPERATIONS: tuple[OperationSpec[Any, Any], ...] = (
    ...
    _spec(
        name="spawn.gc",
        description="Reap stuck running spawns. Use --force <id> to force-finalize one spawn.",
        handler=spawn_gc,
        sync_handler=spawn_gc_sync,
        input_type=SpawnGcInput,
        output_type=SpawnGcOutput,
        cli_group="spawn",
        cli_name="gc",
        mcp_name="spawn_gc",
        surfaces=frozenset({"cli"}),
