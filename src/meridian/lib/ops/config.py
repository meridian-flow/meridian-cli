...
_CONFIG_KEY_SPECS: tuple[_ConfigKeySpec, ...] = (
    ...
    _ConfigKeySpec(
        canonical_key="primary.max_turns",
        section="primary",
        file_key="max_turns",
        field_path=("primary", "max_turns"),
        value_kind="int",
        env_var="MERIDIAN_MAX_TURNS",
        aliases=("max_turns",),
    ),
    _ConfigKeySpec(
        canonical_key="primary.max_input_tokens",
        section="primary",
        file_key="max_input_tokens",
        field_path=("primary", "max_input_tokens"),
        value_kind="int",
        env_var="MERIDIAN_MAX_INPUT_TOKENS",
        aliases=("max_input_tokens",),
    ),
    _ConfigKeySpec(
        canonical_key="primary.max_output_tokens",
        section="primary",
        file_key="max_output_tokens",
        field_path=("primary", "max_output_tokens"),
        value_kind="int",
        env_var="MERIDIAN_MAX_OUTPUT_TOKENS",
        aliases=("max_output_tokens",),
    ),
    _ConfigKeySpec(
        canonical_key="primary.budget",
        section="primary",
        file_key="budget",
        field_path=("primary", "budget"),
        value_kind="float",
        env_var="MERIDIAN_BUDGET",
        aliases=("budget",),
    ),
    _ConfigKeySpec(
...
def _scaffold_template() -> str:
    ...
    lines = [
        ...
        '# harness = ""',
        "# Maximum conversation turns (int; unset = harness default).",
        "# max_turns = 0",
        "# Maximum input tokens per turn (int; unset = harness default).",
        "# max_input_tokens = 0",
        "# Maximum output tokens per turn (int; unset = harness default).",
        "# max_output_tokens = 0",
        "# Budget limit in USD (float; unset = no budget cap).",
        "# budget = 0.0",
