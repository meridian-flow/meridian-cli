...
Preserved from the completed 2026-04-16 remaining-scope plan. Later phases in
the simplified UUID plan regression-test this contract but do not reopen it
unless the runtime-home split introduces a concrete config-surface regression.
